                    ...
                    <Grid container justify="center">
                        <Grid item xs={6}>
                            <Grid container>
                                    ...
                                    <Grid item xs={8}>
                                        <Grid container justify='flex-start' className="textWrap" alignItems="flex-start">
                                            <Grid item component="p">
                                                <b>
                                                Победитель Главного приза<br/>
                                                - поездки в Германию
                                                в легендарные сады Weleda</b>
                                            </Grid>
                                            <Grid item component="p">
                                ...
                                <Grid container className="winnersCard winnersCard_bordered" direction="row-reverse">
                                    <Grid item xs={6} className="imgWrap">
                                    </Grid>
                                    <Grid item xs={6}>
                                        <Grid container alignItems='center' className="textWrap" justify="center">
                                            <Grid item component="p">
